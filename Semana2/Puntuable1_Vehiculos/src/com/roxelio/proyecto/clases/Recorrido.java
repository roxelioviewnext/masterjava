...
public class Recorrido {
	...
	/**
	 * Creamos una hora de llegada aleatoria El rango puede ser desde la hora de
	 * salida de hasta 3h mas tade
	 * 
	 * @return
	 */
	...
	/**
	 * Metodo que calcula la velocidad media del viaje, si la velocidad media del
	 * vehiculo es mayor que su velocidad maxima, la velocidad media es su velocidad
	 * maxima
	 * 
	...
	/**
	 * Devuelve un string con el mes, el dia, la hora y los minutos del
	 * LocalDateTime insertado
	 * 
	 */
	...
	public String toString() {
		...
		builder.append("Recorrido [salida=");
		builder.append(getLocalDateTimeFormatted(salida));
		builder.append(", llegada=");
		builder.append(getLocalDateTimeFormatted(llegada));
		builder.append(", duracion=");
		builder.append(getDuracionString());
		builder.append(", velocidadMedia=");
		builder.append(velocidadMedia);
		builder.append(", metrosRecorridos=");
		builder.append(metrosRecorridos);
		builder.append("]");
